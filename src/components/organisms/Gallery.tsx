...
const Gallery: FC<GProps> = (props: GProps) => {
  ...
  return (
    <div className="sticky top-[14%] flex flex-col w-screen items-center overflow-x-scroll  ">
      <div className="flex overflow-x-scroll gap-3 3xl:gap-5 py-44 4xl:pb-[200px]  bg-custom-primary px-5 min-w-full ml-[2300px] sm:ml-[2100px] md:ml-[1900px] lg:ml-[1600px] xl:ml-[1400px] 2xl:ml-[800px] 3xl:ml-[1100px] 4xl:ml-[600px]">
